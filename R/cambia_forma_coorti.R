...
#' Prende come argomento un vettore di coorti nel formato "(1974,1979]" e lo 
#' restituisce in formato "1975-1979" (se right = TRUE). Se right = FALSE, 
#' prende "[1974,1979)" e restituisce "1974-1978"
#' 
